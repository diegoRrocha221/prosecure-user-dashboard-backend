...
<head>
    ...
    <title>ProSecureLSP - Verify Email</title>
...
<body>
    ...
    <div class="verify-container">
        <div class="verify-card">
            <div class="header-section">
                ...
                <p class="header-subtitle">Enter the code sent to your email</p>
            </div>
            
            <div class="form-section">
                <div class="email-info">
                    <strong>Email:</strong> <?php echo htmlspecialchars($maskedEmail); ?>
                </div>
                ...
                <div class="resend-section">
                    ...
                    <div id="resendTimer" class="mt-2" style="display: none;">
                        <small class="text-muted">
                            Wait <span style="font-weight: 600; color: var(--secondary-color);" id="countdown">60</span> seconds
                        </small>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        async function verifyCode() {
            ...
            try {
                const response = await fetch('./password_reset_api.php?action=verify_email_code', {
                    method: 'POST',
                    headers: {
                ...
                if (data.success) {
                    ...
                    setTimeout(() => {
                        if (data.requires_mfa) {
                            window.location.href = './verify_reset_mfa.php';
                        } else {
        ...
        async function resendCode() {
            ...
            try {
                const response = await fetch('./password_reset_api.php?action=resend_email_code', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    }
                ...
                if (data.success) {
                    showAlert('success', data.message || 'New code sent to your email');
                    clearCodes();
