...
function password_changed_notification_template($email, $ip, $location, $device, $browser, $timestamp) {
    ...
    $content = '
        <div style="background: #fff3cd; border-left: 4px solid #ffc107; padding: 1rem; margin-bottom: 1.5rem; border-radius: 4px;">
            <p style="color: #856404; margin: 0; font-weight: bold;">
                <span style="font-size: 1.2rem;">&#9888;</span> Your password was recently changed
            </p>
        </div>
        
        <p style="color: #fff; font-size: 1rem; line-height: 1.6;">
            This email confirms that your account password was successfully changed on <strong>' . htmlspecialchars($timestamp) . '</strong>.
        </p>
        ...
        <div style="background: rgba(255, 255, 255, 0.1); padding: 1.5rem; border-radius: 8px; margin: 1.5rem 0;">
            ...
            <table style="width: 100%; color: #fff; font-size: 0.95rem;">
                <tr>
                    <td style="padding: 0.5rem 0; width: 30%;"><strong>Date &amp; Time:</strong></td>
