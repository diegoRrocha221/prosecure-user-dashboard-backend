...
<body>
            ...
            <div class="form-section">
                ...
                <div class="text-center mb-4">
                    ...
                    <p style="color: var(--text-light); font-size: 0.9rem;">
                        We've sent a 6-digit code to the registered phone
                    </p>
                </div>
    ...
    <script>
        ...
        async function verifyCode() {
            ...
            try {
                const response = await fetch('./password_reset_api.php?action=verify_sms_code', {
                    method: 'POST',
                    headers: {
        ...
        async function resendCode() {
            ...
            try {
                const response = await fetch('./password_reset_api.php?action=resend_sms_code', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    }
