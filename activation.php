...
function valid_username($username){
    ...
    $sql = "SELECT email from master_accounts WHERE username = '$username'";
...
<div class="login-page">
    <div class="form">
        ...
        <?php if(isset($_GET['regis'])){ echo '<p style="color:green"> success to create your account </p>' ;} ?>
        <?php if(isset($_GET['nh'])){ echo '<p style="color:red"> invalid username or passphrase </p>' ;} ?>
        <?php if(isset($_GET['erf2'])){ echo '<p style="color:red"> invalid email </p>' ;} ?>
        <?php if(isset($_GET['erf3'])){ echo '<p style="color:red"> try again </p>' ;} ?>
