...
unset($_SESSION['password_reset_mfa_required']);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <script>
        ...
        document.getElementById('resetForm').addEventListener('submit', async function(e) {
            ...
            try {
                ...
                if (data.success) {
                    showAlert('success', data.message || 'Verification code sent to your email');
                ...
                resetBtn.innerHTML = '<i class="fas fa-paper-plane me-2"></i>Send Verification Code';
            }
        });
